...
const Login = () => {
	...
	return (
		<div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-140 z-50">
			<div className="bg-black p-12 w-[500px] h-auto shadow-lg m-auto">
